...
- ✅ Fixed (2026-07-16): Market event staleness (found 2026-07-15, see above) — `Market_Events` now has a one-time historical backfill plus a recurring weekly job keeping it current going forward.
  ...
  - **Not fixed / minor gap noted**: the market-events list page's Type filter buttons (`ALL/POLICY/GEOPOLITICAL/SECTORAL/ECONOMIC`) don't include "earnings" as an option even though it's now 218 of 316 rows — frontend-only, not touched this round.
